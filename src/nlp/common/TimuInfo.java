...
public class TimuInfo {
	public String origQuestion;//原文本用\t或@分隔，主要用于调试
	public String question;//题干+选项不加分隔符
	public String bjText;//背景文本
	public String thText;//套话文本
	public List<String> sxwText;//上下文文本
	public String xxText;//选项的文本
	public String tgText;//题干的文本
	public String allTag;//整句话句法分析结果
	public List<String> allTagList;//整句话句法分析结果list
	public String xxTag;//选项句法分析结果
	public String tgTag;//题干整句话句法分析结果
	public Tree allTree;//整句话句法树
	public String xxType;//选项的类型
	public String hxType;//题干核心的类型
	public String qdType;//TODO 题干前导的类型 待修改为list
	
	/**根据选项问句的分词结果进行二阶模板的生成*/
	public TimuInfo(String strlist , int flag) throws IOException{
